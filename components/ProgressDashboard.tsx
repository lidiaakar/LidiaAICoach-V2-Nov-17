...
/**
 * The ProgressDashboard component visualizes the user's performance and improvement
 * across all completed sessions.
 */
const ProgressDashboard: React.FC<ProgressDashboardProps> = ({ history, onBackToDashboard }) => {
